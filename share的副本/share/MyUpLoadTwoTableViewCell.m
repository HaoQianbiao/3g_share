...
@implementation MyUpLoadTwoTableViewCell

-(instancetype) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    self = [super initWithStyle:style reuseIdentifier:reuseIdentifier];
    NSArray* labelArray = [[NSArray alloc] initWithObjects:@"黄昏之后爱意仍在", @"share小奈", @"13分钟以前", @"傍晚总是这样", @"share梓萱", @"19分钟以前", @"保持热爱 奔赴山海", @"share可可", @"25分钟以前", @"海平面的你和我", @"share小沫", @"30分钟以前", @"人间惊鸿", @"share慧子", @"45分钟以前",nil];;
    NSMutableArray* viewArray = [[NSMutableArray alloc] init];
    
    for (int j = 0; j < 5; j++) {
        _view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 415, 150)];
        NSString* str = [[NSString alloc] initWithFormat:@"/Users/haoqianbiao/Desktop/test1/UI/share/article/%d.jpeg",  (j + 11)];
