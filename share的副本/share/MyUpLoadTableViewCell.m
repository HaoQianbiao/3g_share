...
@implementation MyUpLoadTableViewCell

-(instancetype) initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    self = [super initWithStyle:style reuseIdentifier:reuseIdentifier];
    
    NSArray* labelArray = [[NSArray alloc] initWithObjects:@"永远保持快乐", @"share小小", @"16分钟以前", @"枯燥的生活", @"share熊仔", @"20分钟以前", @"快乐星球", @"share光头强", @"25分钟以前", @"房间一隅", @"share晓雯", @"30分钟以前", @"蓝天白云", @"share慧慧", @"45分钟以前",nil];
    NSMutableArray* viewArray = [[NSMutableArray alloc] init];
    
    for (int j = 0; j < 5; j++) {
        _view = [[UIView alloc] initWithFrame:CGRectMake(0, 0, 415, 150)];
        NSString* str = [[NSString alloc] initWithFormat:@"/Users/haoqianbiao/Desktop/test1/UI/share/article/%d.jpeg",  (j + 1)];
